    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 px-10 py-12 rounded-[2.5rem] glass-panel shadow-[0_0_50px_rgba(0,0,0,0.5)] max-w-sm w-full animate-in zoom-in-95 duration-500 border border-border">
        ...
        <div className="relative">
          <div className="absolute -inset-8 rounded-full border border-accent/20 animate-ping shadow-[0_0_20px_rgba(16,185,129,0.1)]" style={{ animationDuration: '2s' }} />
          <div className="absolute -inset-4 rounded-full border-2 border-accent/40 animate-pulse shadow-[0_0_20px_rgba(16,185,129,0.2)]" />
        ...
        <div className="flex items-center gap-10 pt-4">
          ...
          <button
            ...
            className="group flex flex-col items-center gap-3"
          >
            <div className="w-16 h-16 rounded-full bg-accent flex items-center justify-center transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.4)] group-hover:shadow-[0_0_40px_rgba(16,185,129,0.6)] group-hover:scale-110">
